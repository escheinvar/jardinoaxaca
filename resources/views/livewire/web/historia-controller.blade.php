        ...
        <div class="container py-5 px-3">
            ...
            <div class="row justify-content-around py-5">
                <div class="col-sm-auto col-md-6 col-lg-5 text-end px-4 mb-4">
                    ...
                    <h3 class="cita">El Jardín Etnobiológico resguarda una pequeña parte del inmenso patrimonio biocultural del estado de Oaxaca. </h3>
                </div>
                <div class="col-sm-auto col-md-6 col-lg-6 col-xl-5 text-start py-2 px-4">
                    ...
                    <p class="texto-secundario">Aunque nuestra historia inicia en 1993, nuestro terreno tiene una historia muy antigua, ya que formaba parte del patio y antigua huerta
                        del convento de Santo Domingo de Guzmán construido por los oaxaqueños en los siglos XVI y XVII para los frailes dominicos.</p>
                </div>
            </div>
            <div class="row justify-content-around py-5">
                <div class="col-sm-auto col-md-12 col-lg-12  px-4 mb-4">
                    ...
                    <p class="texto-secundario">En 1994 con la salida del ejército de las instalaciones del ex-convento de Santo Domingo, se inicia el proceso de rescate 
                        ...
                        <div class="container py-5 px-4">
                            <div class="row pb-5">
                                <div class="col">
                                    <h2 style="text-align: center;">Construcción del Jardín</h2>
                                    <div class="owl-carousel owl-theme">
                                        <div>
                                            <a href="imagenes/slider-5_historia/img-01.jpg" data-fancybox="gallery6">
                                                <img src="imagenes/slider-5_historia/img-con-01.jpg" alt="Toma aérea de la construcción">
                                        ...
                                        <div>
                                            <a href="imagenes/slider-5_historia/img-01.jpg" data-fancybox="gallery6">
                                                <img src="imagenes/slider-5_historia/img-con-02.jpg" alt="Toma aérea de la construcción">
                                        ...
                                        <div>
                                            <a href="imagenes/slider-5_historia/img-01.jpg" data-fancybox="gallery6">
                                                <img src="imagenes/slider-5_historia/img-con-03.jpg" alt="Toma aérea de la construcción">
                                                {{-- <h3 class="w-100"> Horno de cerámica del Ex Convento de Santo Domingo | Foto: Ernesto de
                                                    los Santos Reyes</h3> --}}
                                            </a>
                                        </div>
                                        <div>
                                            <a href="imagenes/slider-5_historia/img-01.jpg" data-fancybox="gallery6">
                                                <img src="imagenes/slider-5_historia/img-con-04.jpg" alt="Toma aérea de la construcción">
                                                {{-- <h3 class="w-100"> Horno de cerámica del Ex Convento de Santo Domingo | Foto: Ernesto de
                                                    los Santos Reyes</h3> --}}
                                            </a>
                                        </div>
                                        <div>
                                            <a href="imagenes/slider-5_historia/img-01.jpg" data-fancybox="gallery6">
                                                <img src="imagenes/slider-5_historia/img-con-05.jpg" alt="Toma aérea de la construcción">
                                                {{-- <h3 class="w-100"> Horno de cerámica del Ex Convento de Santo Domingo | Foto: Ernesto de
                                                    los Santos Reyes</h3> --}}
                                            </a>
                                        </div>
                    ...
                    <p class="texto-secundario">
                        Desde su fundación, en este Jardín, respetamos y apreciamos la postura de los pueblos originarios que buscan conservar su lengua y su cultura para transmitirla con facilidad a las nuevas generaciones y también para fortalecer sus derechos políticos.
                    </p>
                    <p class="texto-secundario">
        ...
        <div class="container py-5 px-4">
            <div class="row pb-5">
                <div class="col">
                    ...
                    <div class="owl-carousel owl-theme">
                        <div>
                            <a href="imagenes/slider-5_historia/img-01.jpg" data-fancybox="gallery5">
                                <img src="imagenes/slider-5_historia/img-pre-01.jpg" alt="Área escultórica">
                                <h3 class="w-100"> Horno de cerámica del Ex Convento de Santo Domingo | Foto: Ernesto de
                                    los
                                    Santos Reyes</h3>
                            </a>
                        ...
                        <div>
                            <a href="imagenes/slider-5_historia/img-02.jpg" data-fancybox="gallery5">
                                <img src="imagenes/slider-5_historia/img-pre-02.jpg" alt="Hornos de cal">
                        ...
                        <div>
                            <div>
                                <a href="imagenes/slider-5_historia/img-03.jpg" data-fancybox="gallery5">
                                    <img src="imagenes/slider-5_historia/img-pre-03.jpg" alt="Horno del Ex Convento">
