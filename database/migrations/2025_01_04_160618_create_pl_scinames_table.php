...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('pl_scinames', function (Blueprint $table) {
            ...
            $table->foreignId('scn_ckewtaxonid')->constrained('cat_kew_plantsoftheworld','ckew_taxonid')->nullable();  ##### ID de tabla pl_plantas
            $table->integer('scn_tipo')->default('0');  ##### Tipo de nombre: 0=campo, 1=tecnico, 2=autoridad1, 3=autoridad1y2;
